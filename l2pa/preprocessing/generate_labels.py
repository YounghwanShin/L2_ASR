...
Generates D/I/S/C labels by aligning canonical and perceived phoneme sequences.
"""
...
def needleman_wunsch_align(canonical, perceived):
  ...
  Args:
    canonical: Canonical phoneme list.
    perceived: Perceived phoneme list.
...
def generate_error_labels(canonical_str, perceived_str):
  """Generates error labels (D/I/S/C) from phoneme strings.
